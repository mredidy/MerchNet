...
TOKEN_CONTRACT = '0x6c3ea9036406852006290770bedfcaba0e23a0e8'
SCOPES = [
...
def update_sheet():
    ...
    # === Query BigQuery for PYUSD transfers ===
    query = f"""
    SELECT
