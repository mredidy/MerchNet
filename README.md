...
You can access the [MerchNet Colab Notebook](https://colab.research.google.com/github/mredidy/MerchNet/blob/main/MerchNet_Analytics.ipynb.ipynb) to explore and run the project interactively.
